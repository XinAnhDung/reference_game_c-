...
// hàm hỗ trợ in màu trên khoảng trắng và chuỗi
void Tao_mau_cho_o(int x, int y, int text_color, int background_color, std::string name) {
	// 0: black; 1: blue; 2: green; 3: Aqua; 4: Red; 5: Purple; 6: Yellow; 7: white; 8: Gray
	//9: Light blue; 10: Light green; 11: light aqua; 12: light red; 13: light purple; 14: light yellow; 15: bright white
	setBackgroundColor(background_color);
	setColor(text_color);// thay đổi màu chữ của chuỗi
	// bắt đầu đỗi màu chữ
	int len = name.length();
	for (int i = 0; i < len; ++i)
	{
	...
	setBackgroundColor(0); // đặc lại nền đen
}